    ...
    <div className="min-h-screen bg-[#121212] text-white">
      ...
      <main className="pt-[113px] md:pt-[62px]">
        ...
        <section className="border-b border-[#242424]">
          <div className="musicboxd-container max-w-[1080px] py-7 md:py-9">
            <div className="mx-auto max-w-[760px]">
              <div className="grid grid-cols-3 overflow-hidden rounded-xl border border-[#303030] bg-[#181818]">
              ...
              <div className="mx-auto mt-6 max-w-[420px]">
                <div className="relative">
                  <input
                    ...
                    className="h-10 w-full rounded-full border border-[#303030] bg-[#181818] px-4 pr-10 text-xs text-white placeholder:text-[#5f5f5f] transition-colors focus:border-[#4a4a4a]"
                  />
...
function BrowseButton({ label }: { label: string }) {
  return (
    <button
      type="button"
      className="flex h-11 items-center justify-center gap-2 border-r border-b border-[#303030] bg-[#181818] px-3 text-[10px] font-bold tracking-[0.08em] text-[#858585] transition-colors hover:bg-[#202020] hover:text-white [&:nth-child(3n)]:border-r-0 [&:nth-child(n+4)]:border-b-0"
    >
      {label}

      <span className="text-[9px] text-[#5f5f5f]">⌄</span>
    </button>
  );
}
